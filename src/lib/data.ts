...
export const experiencesData = [
  
  {
    ...
    company:
    "Sydney College",
    tasks: ["Maintain and monitor computer network, school system, and application software.","Develop and manage SMMS using AngularJS, NodeJS, and Express Framework.","Design and develop system configurations.","Develop and maintain school websites with WordPress, PHP, and JavaScript.","Manage cloud server and student database (AWS EC2 and Hosting).","Direct system installations, evaluate system operations and manage databases.","Install and configure computer systems, diagnose hardware/software faults, and solve technical problems.","Regularly update and maintain school network systems, service servers, and software.","Provide network inventory, troubleshoot system procedures, and determine equipment repair replacement needs."
  ],
